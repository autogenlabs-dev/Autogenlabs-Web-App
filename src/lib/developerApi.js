...
export const developerApi = {
     ...
     */
    async updateContentPricing(contentId, contentType, pricingData) {
        const headers = await getAuthHeadersWithRefresh();
     ...
     */
    async updatePaymentDetails(paymentDetails) {
        const headers = await getAuthHeadersWithRefresh();
     ...
     */
    async submitForApproval(contentId, contentType) {
        const headers = await getAuthHeadersWithRefresh();
     ...
     */
    async getSubmissionStatus(contentId, contentType) {
        const headers = await getAuthHeadersWithRefresh();
